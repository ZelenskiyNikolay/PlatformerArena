...
PlatformerArena is a 2D platformer built with MonoGame, featuring custom collision physics, tile-based movement, and enemy AI behavior.
...
UI and game menu
PlatformerArena — это 2D платформер, написанный на MonoGame, с собственным движком для физики, коллизий и поведением врагов.
