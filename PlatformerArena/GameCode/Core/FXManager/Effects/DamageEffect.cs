...
namespace FX
{
    public class DamageEffect : Effect
    {
        ...
        public void SetColorAlpha(byte Alpha) =>_color.A=Alpha;
       
        public DamageEffect(Rectangle RectangleObject, ContentManager Content)
        {
        ...
        public void Update(float dt, Rectangle rectangleObject, Vector2 vectorMov)
        {
            ...
            _dest = new Rectangle(rectangleObject.X, rectangleObject.Y, 100, 50);
